	...
	public partial class Karya5 : Node2D
	{
		...
		private BentukDasar _bbentukDasar = new BentukDasar();
        ...
        //Lingkaran dan ellipes di fungsi MyLingkara
            private void MyLingkaran()
        {
            // Tambahkan Lingkaran di Kuadran I
            var titikLingkaran1 = new Vector2(300, 200);
            var lingkaran1 = _bbentukDasar.Lingkaran(titikLingkaran1, 40);
            GraphicsUtils.PutPixelAll(this, lingkaran1, GraphicsUtils.DrawStyle.DotDot, ColorUtils.ColorStorage(7));

            var titikEllips1 = new Vector2(-320, -220);
            var ellips1 = _bbentukDasar.Elips(titikEllips1, 60, 30);
            GraphicsUtils.PutPixelAll(this, ellips1, GraphicsUtils.DrawStyle.DotDot, ColorUtils.ColorStorage(8));
